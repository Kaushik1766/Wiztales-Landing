        ...
        <div className='border-t border-white'>
            <footer className="bg-white dark:bg-black">
                <div className="container px-6 py-12 mx-auto">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div className="sm:col-span-2">
                            ...
                            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                                ...
                                <Button className='bg-[#ee9c2a] hover:bg-[#ffb467] mx-8 scale-125'> Subscribe</Button>
                    ...
                    <hr className="my-6 border-white md:my-8 dark:border-gray-700" />

                    <div className="flex items-center justify-between">
                        <a href="#">
                            <img className="w-auto h-20" src="https://assets-global.website-files.com/62947d7436f7afbdfa49f716/62bf3510917cfe4cd02a9359_Logo_white%20(1)-p-1080.webp" alt="" />
                        </a>
                    ...
                    <p className='text-sm'>© Wiztales Media Pvt Ltd. All rights reserved</p>
                </div>
            </footer>
        </div>
    )
